/* CreatorBridge - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */
package COM.stagecast.playwrite;
import java.io.File;

public abstract class CreatorBridge extends PlaywriteRoot
{
    private static final boolean CUSTOMER_FLAG = true;
    private static final String RELEASE_TYPE = "f";
    private static final int CONFIG_FLAGS = 1;
	...
	if (_initialWorld != null) {
	    ...
	    this.performCommandLater(this, "NW", null);
    }
