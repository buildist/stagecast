/* FoundationDialog - Decompiled by JODE
...
public class FoundationDialog extends Dialog
{
    ...
    public FoundationDialog(Frame frame, boolean bool) {
	super(frame, bool);
    }
    
    public FoundationDialog(Frame frame, String string, boolean bool) {
	super(frame, string, bool);
    }
